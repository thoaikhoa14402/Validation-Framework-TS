...
//   const result1 = chainValidator.validate('123', {stopOnFailure: false}); // expected error
...
const mixedValidator = __1.default.string()
    .addMethod("beginWithA", (x, errCtx) => {
    return x[0] === "a"
        ? true
        : errCtx.createError({
